...
Este repositorio contiene el desarrollo del proyecto correspondiente a **Investigación Aplicada I (DSS)**, realizado como parte de la asignatura *Desarrollo de Aplicaciones Web con Software Interpretado en el Servidor*.

El proyecto incluye:
- Investigación teórica  
- Análisis del problema  
- Desarrollo práctico  
- Aplicación de los contenidos vistos en clase  

---

## 📅 Ciclo Académico
Ciclo III – Grupo DSS404 G01T  
